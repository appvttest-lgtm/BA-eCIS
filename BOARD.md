...
- [x] Command-rail report layout: sticky sidebar (verdict + counters, file navigator, section nav, bookmarks) + new-audit overlay preserving the current report (v1.12.0) #feature
