...
export const STARTRACK_QR_FIELDS = [
  { num: 1, key: 'receiverSuburb', label: 'Receiver suburb', pos: 1, len: 30, obligation: 'M', rule: 'ST-QR-F01', criteria: 'Non-blank' },
  { num: 2, key: 'receiverPostcode', label: 'Receiver postcode', pos: 31, len: 4, obligation: 'M', rule: 'ST-QR-F02', criteria: '4 digits (9901 for NZ Premium)' },
  { num: 3, key: 'connoteNumber', label: 'Consignment number', pos: 35, len: 12, obligation: 'M', rule: 'ST-QR-F03', criteria: '4 alphanumeric + 8 digits' },
  { num: 4, key: 'freightItemNumber', label: 'Freight item number', pos: 47, len: 20, obligation: 'M', rule: 'ST-QR-F04', criteria: '20-char freight item ID' },
  { num: 5, key: 'productCode', label: 'Product code', pos: 67, len: 3, obligation: 'M', rule: 'ST-QR-F05', criteria: 'Valid StarTrack product code' },
  { num: 6, key: 'payerAccount', label: 'Payer account', pos: 70, len: 8, obligation: 'COND', rule: 'ST-QR-F06', criteria: 'Required for returns/transfers' },
  { num: 7, key: 'senderAccount', label: 'Sender account', pos: 78, len: 8, obligation: 'COND', rule: 'ST-QR-F07', criteria: 'Required for despatch movements' },
  { num: 8, key: 'consignmentQuantity', label: 'Consignment quantity', pos: 86, len: 4, obligation: 'M', rule: 'ST-QR-F08', criteria: 'Numeric, >= 1' },
  { num: 9, key: 'consignmentWeight', label: 'Consignment weight', pos: 90, len: 5, obligation: 'M', rule: 'ST-QR-F09', criteria: 'Numeric whole kg' },
  { num: 10, key: 'consignmentCube', label: 'Consignment cube', pos: 95, len: 5, obligation: 'COND', rule: 'ST-QR-F10', criteria: 'Numeric m3 x 1000 (or *****); req. non-satchel' },
  { num: 11, key: 'despatchDate', label: 'Despatch date', pos: 100, len: 8, obligation: 'M', rule: 'ST-QR-F11', criteria: 'YYYYMMDD valid date' },
  { num: 12, key: 'receiverName1', label: 'Receiver name', pos: 108, len: 40, obligation: 'M', rule: 'ST-QR-F12', criteria: 'Non-blank' },
  { num: 13, key: 'receiverName2', label: 'Receiver name 2', pos: 148, len: 40, obligation: 'O', rule: null, criteria: 'Optional' },
  { num: 14, key: 'unitType', label: 'Unit type', pos: 188, len: 3, obligation: 'M', rule: 'ST-QR-F14', criteria: 'Appendix A unit permitted for product' },
  { num: 15, key: 'destinationDepot', label: 'Destination depot', pos: 191, len: 4, obligation: 'M', rule: 'ST-QR-F15', criteria: 'Non-blank' },
  { num: 16, key: 'receiverAddress1', label: 'Receiver address', pos: 195, len: 40, obligation: 'M', rule: 'ST-QR-F16', criteria: 'Non-blank' },
  { num: 17, key: 'receiverAddress2', label: 'Receiver address 2', pos: 235, len: 40, obligation: 'O', rule: null, criteria: 'Optional' },
  { num: 18, key: 'receiverPhone', label: 'Receiver phone', pos: 275, len: 14, obligation: 'O', rule: 'ST-QR-F18', criteria: 'Numeric when present' },
  { num: 19, key: 'dangerousGoodsIndicator', label: 'Dangerous goods indicator', pos: 289, len: 1, obligation: 'M', rule: 'ST-QR-F19', criteria: 'Y or N' },
  { num: 20, key: 'movementTypeIndicator', label: 'Movement type indicator', pos: 290, len: 1, obligation: 'M', rule: 'ST-QR-F20', criteria: 'N, C or T' },
  { num: 21, key: 'notBeforeDate', label: 'Book-in not-before date', pos: 291, len: 12, obligation: 'COND', rule: 'ST-QR-F21', criteria: 'YYYYMMDDHHMM, <= not-after' },
  { num: 22, key: 'notAfterDate', label: 'Book-in not-after date', pos: 303, len: 12, obligation: 'COND', rule: 'ST-QR-F22', criteria: 'YYYYMMDDHHMM' },
  { num: 23, key: 'atlNumber', label: 'ATL number', pos: 315, len: 10, obligation: 'COND', rule: 'ST-QR-F23', criteria: 'C999999999 when present' },
  { num: 24, key: 'raNumber', label: 'RA/TA number', pos: 325, len: 10, obligation: 'COND', rule: 'ST-QR-F24', criteria: 'Required for movement C/T' }
];
